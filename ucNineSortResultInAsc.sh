...
#ARITHMETIC COMPUTATION AND SORTING : USE CASE 9 ->  SORT THE RESULT IN ASCENDING ORDER.
...
sortResult () {
	...
	echo $message " SORTED RESULT : " ${arithmeticArray[@]};
}
...
arithmeticMain () {
	...
	displayArrayElements;
	#sortResult -nr;
	sortResult -lt "DESCENDING";
	#sortResult -n;
   sortResult -gt "ASCENDING";
}
